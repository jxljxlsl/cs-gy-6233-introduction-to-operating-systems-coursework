...
PRINT = runoff.list runoff.spec README n.txt big_test_file.txt long_test_file.txt test_file.txt toc.hdr toc.ftr $(FILES)
...
EXTRA=\
	...
	printf.c umalloc.c\
	README n.txt big_test_file.txt long_test_file.txt test_file.txt dot-bochsrc *.pl toc.* runoff runoff1 runoff.list\
