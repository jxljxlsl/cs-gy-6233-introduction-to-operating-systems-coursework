...
fs.img: mkfs README.md n.txt $(UPROGS)
	./mkfs fs.img README.md n.txt $(UPROGS)
...
PRINT = runoff.list runoff.spec README n.txt toc.hdr toc.ftr $(FILES)
...
EXTRA=\
	...
	printf.c umalloc.c\
	README n.txt dot-bochsrc *.pl toc.* runoff runoff1 runoff.list\
